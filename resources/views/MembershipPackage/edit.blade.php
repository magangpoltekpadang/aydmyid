<form @submit.prevent="updateMembershipPackage"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedMembershipPackage.package_name"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedMembershipPackage.duration_days"
                class="w-full h-11 px-3 pl-9 text-sm text-gray-800 dark:text-grey-600 bg-white dark:bg-white-800 border border-white-300 dark:border-gray-700 rounded-md shadow-sm" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedMembershipPackage.price"
                class="w-full h-11 px-3 pl-9 text-sm text-gray-800 dark:text-grey-600 bg-white dark:bg-white-800 border border-white-300 dark:border-gray-700 rounded-md shadow-sm" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedMembershipPackage.max_vehicles"
                class="w-full h-11 px-3 pl-9 text-sm text-gray-800 dark:text-grey-600 bg-white dark:bg-white-800 border border-white-300 dark:border-gray-700 rounded-md shadow-sm" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <textarea type="text" x-model="editedMembershipPackage.description"
