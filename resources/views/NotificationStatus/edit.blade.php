<form @submit.prevent="updateNotificationStatus"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedNotificationStatus.status_name"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedNotificationStatus.code"
                class="w-full h-11 px-3 pl-9 text-sm text-gray-800 dark:text-grey-600 bg-white dark:bg-white-800 border border-white-300 dark:border-gray-700 rounded-md shadow-sm" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <textarea type="text" x-model="editedNotificationStatus.description"
