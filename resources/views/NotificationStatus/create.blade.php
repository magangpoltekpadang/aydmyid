<form action="{{ route('notification-status.store') }}" method="POST"
    class="rounded-xl border border-gray-200 dark:bg-white-900 dark:border-white p-5 space-y-5 shadow-sm">
    @csrf
    <h2 class="text-lg font-semibold text-gray-800 dark:text-gray">Add New Status</h2>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" id="status_name" name="status_name" value="{{ old('status_name') }}" required
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" id="code" name="code" value="{{ old('code') }}" required placeholder="Code"
                class="w-full h-11 px-3 pl-9 text-sm text-black bg-white border border-white-300 dark:border-gray-700 rounded-md shadow-sm placeholder:text-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-300" />
        </div>
    </div>
