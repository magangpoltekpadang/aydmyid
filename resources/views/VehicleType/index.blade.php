...
<div x-data="vehicleTypeData()" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="#" @click.prevent="alert('Create functionality would go here')"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="vehicleType in vehicleTypes" :key="vehicleType.vehicle_type_id">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900" x-text="vehicleType.type_name"></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="vehicleType.code"></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="vehicleType.description"></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span :class="vehicleType.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'"
...
@push('scripts')
<script src="{{ asset('js/vehicles/vehicle_type_script.js') }}"></script>
@endpush
@endsection