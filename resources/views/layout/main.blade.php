...
<body class="font-sans">
    <div class="flex h-screen">
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
            ...
            <ul class="mt-6">
                ...
                <li class="relative px-6 py-3">
                    ...
                    @endif
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150  
                            {{ request()->is('vehicle-type') ? 'text-blue-600 dark:text-blue-600' : 'text-gray-600 dark:text-gray-700' }} 
                            hover:text-grey-100 dark:hover:text-grey-200"
                        href="/vehicle-type">
                ...
                <li class="relative px-6 py-3">
                    ...
                    @endif
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150  
                            {{ request()->is('role') ? 'text-blue-600 dark:text-blue-600' : 'text-gray-600 dark:text-gray-700' }} 
                            hover:text-grey-100 dark:hover:text-grey-200"
                        href="/role">
                ...
                <li class="relative px-6 py-3">
                    ...
                    @endif
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150  
                            {{ request()->is('membership-package') ? 'text-blue-600 dark:text-blue-600' : 'text-gray-600 dark:text-gray-700' }} 
                            hover:text-grey-100 dark:hover:text-grey-200"
        ...
        <!-- Main content area -->
        <div class="container px-3 mx-auto grid bg-gray-100 dark:bg-gray-150">
