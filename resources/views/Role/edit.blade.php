<form @submit.prevent="updateRole"
    ...
    {{-- Role Name --}}
    <div>
        <label for="role_name" class="block mb-1 font-semibold">Role Name</label>
        <div class="relative">
            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 text-sm">
                <i class="fa fa-car" aria-hidden="true"></i>
            </span>
            <input type="text" x-model="editedRole.role_name"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" x-model="editedRole.code"
                class="w-full h-11 px-3 pl-9 text-sm text-gray-800 dark:text-grey-600 bg-white dark:bg-white-800 border border-white-300 dark:border-gray-700 rounded-md shadow-sm" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <textarea type="text" x-model="editedRole.description"
