<form @submit.prevent="updateTransactionService"
            ...
            <select x-model="editedTransactionService.transaction_id"
                ...
                <template x-for="transaction in transactions" :key="transaction.transaction_id">
                    <option :value="transaction.transaction_id"
                        x-text="transaction.transaction_id + ' ' + transaction.transaction_code"></option>
                </template>
            </select>
        </div>
    </div>
        ...
        <div class="relative">
            ...
            <select x-model="editedTransactionService.service_id"
                ...
                <template x-for="service in services" :key="service.service_id">
                    <option :value="service.service_id" x-text="service.service_id + ' ' + service.service_name">
                    </option>
                </template>
            </select>
        </div>
    ...
    <div>
        ...
        <input type="time" x-model="editedTransactionService.start_time" class="w-full border rounded px-3 py-2"
            required>
        @error('start_time')
    ...
    <div>
        ...
        <input type="time" x-model="editedTransactionService.end_time" class="w-full border rounded px-3 py-2"
            required>
        @error('end_time')
            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
        @enderror
    ...
    <div>
        ...
        <div class="relative">
            ...
            <select id="status" name="status" x-model="editedTransactionService.status"
